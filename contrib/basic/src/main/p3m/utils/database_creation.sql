...
#=============================================================
#GRANT ALL PRIVILEGES ON TABLE medline_citation TO 'root'@'%' identified by '';
#GRANT ALL PRIVILEGES ON TABLE medline_author TO 'root'@'%' identified by '';
#GRANT ALL PRIVILEGES ON TABLE medline_chemical_list TO 'root'@'%' identified by '';
#GRANT ALL PRIVILEGES ON TABLE medline_mesh_heading TO 'root'@'%' identified by '';
#GRANT ALL PRIVILEGES ON TABLE medline_comments_corrections TO 'root'@'%' identified by '';
#GRANT ALL PRIVILEGES ON TABLE medline_citation_subsets TO 'root'@'%' identified by '';
#GRANT ALL PRIVILEGES ON TABLE medline_article_publication_type TO 'root'@'%' identified by '';
#GRANT ALL PRIVILEGES ON TABLE medline_article_language TO 'root'@'%' identified by '';
#GRANT ALL PRIVILEGES ON TABLE medline_grant TO 'root'@'%' identified by '';
#GRANT ALL PRIVILEGES ON TABLE medline_data_bank TO 'root'@'%' identified by '';
#GRANT ALL PRIVILEGES ON TABLE medline_personal_name_subject TO 'root'@'%' identified by '';
#GRANT ALL PRIVILEGES ON TABLE medline_citation_other_id TO 'root'@'%' identified by '';
#GRANT ALL PRIVILEGES ON TABLE medline_investigator TO 'root'@'%' identified by '';
